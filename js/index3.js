...
document.querySelector('.redpiece path').onmouseenter = function() {
  document.querySelector('.redpiece path').style.fill = `rgb(${anime.random(0,254)},${anime.random(0,255)},${anime.random(0,255)})`
...
document.querySelector('.redpiece2 path').onmouseenter= function() {
  document.querySelector('.redpiece2 path').style.fill = `rgb(${anime.random(0,254)},${anime.random(0,255)},${anime.random(0,255)})`
...
document.querySelector('.purplepiece path').onmouseenter = function() {
  document.querySelector('.purplepiece path').style.fill = `rgb(${anime.random(0,254)},${anime.random(0,255)},${anime.random(0,255)})`
